...
export FETCH_OSC_MAX_BATCH_SIZE=1
export FETCH_OSC_RETRY_DELAY=300
export FETCH_OSC_CONNECT_TIMEOUT=120
export FETCH_OSC_KEEPALIVE_TIME=300
export FETCH_OSC_PARALLEL_MAX=1
export FETCH_OSC_SPEED_LIMIT=102400
export FETCH_OSC_SPEED_TIME=120
